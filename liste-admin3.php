                      ...
                      <table class="display" id="basic-1">
                        ...
                        ?> 
                          <tr>
                            ...
                            <td> 
                            <a href="modif-admin3.php?id=<?php echo $donnees['id']; ?>" class="btn btn-primary">Modifier</a>
                             <span class="btn btn-danger">
                             <a href="controller/suppAdmin.php?id=<?php echo $donnees['id']; ?>" style="color: #fff;">supprimer</a>
                            </span>
