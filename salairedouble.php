...
$id = $_GET['id'];
$req = $bdd->query(" SELECT * FROM pointage WHERE idd=$id and  month(date)=month(current_date)");
$donnees = $req->fetch();
?>
<?php $res2=0;
$total1=0; 
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-header">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Liste pointage du dernier mois de <?php echo $donnees['nom']?>  <?php echo $donnees['prenom']?></h3>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                        ...
                        ?> 
                          ...
                          <td><?php echo $donnees['id'] ?></td>
                            ...
                            <td value="nb">
                             ...
                             $salaire=$nb_heures*10+$nb_minutes*10/60;
                      ...
                      <input type="text" value="<?php echo $res2 ?>">
                      

                      <label for="">Salaire</label>
                      <input type="text" value="<?php echo $salaire ?> dt">
                    </div>
                  </div>
                </div>
              </div>
