                      ...
                      <?php 
                       ...
                       ?> 
                          <tr>
                            ...
                            <td> 
                            <a href="modif-service3.php?id=<?php echo $donnees['id']; ?>" class="btn btn-primary">Modifier</a>

                      <a href="#">
                        <button type="button" class="btn btn-secondary">Absence</button> </a>

                        
                        <span class="btn btn-danger">
                             <a href="controller/suppService.php?id=<?php echo $donnees['id']; ?>" style="color: #fff;">supprimer</a>
                            </span>
                       </td>
                          </tr>
                          <?php } ?>
