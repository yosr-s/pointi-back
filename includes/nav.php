<div class="page-main-header">
        <div class="main-header-right row m-0">
          <div class="main-header-left">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="assets/images/logo/pointii.png" alt=""></a></div>
          ...
          <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown p-0">
                <button class="btn btn-primary-light" type="button"><a href="includes/deconnecter.php"><i data-feather="log-out"></i>Log out</a></button>
              </li>
            </ul>
          </div>
