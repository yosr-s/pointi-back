                      ...
                      <table class="display" id="basic-1">
                         <?php 
                                        ...
                                        <div class="alert alert-success" role="alert">
                                         notification ajouté avec succès!
                                        </div>
                                    <?php } } ?>
                                     <?php 
                                            if (isset($_GET['resultat'])) {
                                           ...
                                           ?>
                                        <div class="alert alert-success" role="alert">
                                          notification modifié avec succès!
                                        </div>
                                    <?php } } ?>
                                    <?php 
                                            if (isset($_GET['resultat'])) {
                                        ...
                                        <div class="alert alert-danger" role="alert">
                                         notification supprimé avec succès!
                                        </div>
                                    <?php } } ?>
                        <thead>
                          <tr>
                       ...
                       ?> 
                          <tr>
                            ...
                            <td> 
                            <a href="modif-notif.php?id=<?php echo $donnees['id']; ?>" class="btn btn-primary">Modifier</a>

                     
                        
                        <span class="btn btn-danger">
                             <a href="controller/suppnotif.php?id=<?php echo $donnees['id']; ?>" style="color: #fff;">supprimer</a>
                            </span>
                       </td>
                          </tr>
                          <?php } ?>
