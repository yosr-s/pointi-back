            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-wizard" id="regForm" action="controller/modifAdmin.php?id=<?php echo $donnees['id'];?>" method="POST">
                      <div class="tab">
                        <div class="form-group">
                          <label for="name">Nom</label>
                          <input class="form-control" id="name" type="text"  required="required" name="nom" value="<?php echo $donnees['nom'] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control digits" id="contact" type="text" name="login" value="<?php echo $donnees['login'] ?>">
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="exampleFormControlSelect1" name="type" value="<?php echo $donnees['type'] ?>">
