...
?> 
                  <tr>
                    ...
                    <td><?php echo $donnees['dps'] ?>-<?php echo $donnees['fps'] ?></td>
                    <td><?php echo $donnees['dps'] ?>-<?php echo $donnees['fps'] ?></td>
                    <td><?php echo $donnees['dps'] ?>-<?php echo $donnees['fps'] ?></td>
                    <td><?php echo $donnees['dps'] ?>-<?php echo $donnees['fps'] ?></td>
                    <td><?php echo $donnees['dps'] ?>-<?php echo $donnees['fps'] ?></td>
                  ...
                  <tr>
                    ...
                    <td><?php echo $donnees['dds'] ?>-<?php echo $donnees['fds'] ?></td>
                    <td><?php echo $donnees['dds'] ?>-<?php echo $donnees['fds'] ?></td>
                    <td><?php echo $donnees['dds'] ?>-<?php echo $donnees['fds'] ?></td>
                    <td><?php echo $donnees['dds'] ?>-<?php echo $donnees['fds'] ?></td>
                    <td><?php echo $donnees['dds'] ?>-<?php echo $donnees['fds'] ?></td>
                    ...
                    <label for="">nb heures/mois:</label>
                          ...
                          <input type="text" value="<?php echo $donnees['prix'] ?>" readonly>
                          <br>
                          <label for="">Prix heure supplémentaire:</label>
                          <input type="text" value="<?php echo $donnees['prixhsup'] ?>" readonly>
                          <?php } ?>
