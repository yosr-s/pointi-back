            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-wizard" id="regForm" action="controller/ajoutSalarie.php" method="POST" enctype="multipart/form-data"> 
                      <div class="tab">
                        ...
                        <div class="form-group">
                          <label for="contact">Num carte d'identité</label>
                          <input class="form-control digits" id="contact" type="text" placeholder="********" name="cin">
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control digits" id="contact" type="password" placeholder="bootstrap@gmail.com" name="password">
                        </div>
                        <div class="form-group">
                          <label for="contact">Service</label>
                          <input class="form-control digits" id="contact" type="text" placeholder="Service" name="service">
                        </div>
                        <div class="form-group">
                          <label for="contact">Salaire</label>
                          <input class="form-control digits" id="contact" type="text" placeholder="Salaire" name="salaire">
                        </div>
                        <div class="form-group">
